...
/// In-memory feed of mirrored notifications, newest first. Capped so a chatty phone
/// can't grow this unbounded; persistence across launches is a later-phase concern.
@Observable
