    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="divide-y divide-black/5 dark:divide-white/10 rounded-xl border border-black/5 dark:border-white/10">
            {MIRROR_QUALITY_OPTIONS.map((option) => (
              <button
                ...
                className="flex w-full items-start gap-3 px-3.5 py-3 text-left transition-colors hover:bg-black/[0.02] dark:hover:bg-white/[0.04]"
              >
                <span
        ...
        <SettingsGroup title="File Transfers">
          <div className="flex items-center justify-between rounded-xl border border-black/5 dark:border-white/10 px-3.5 py-3">
            <div>
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-xl border border-black/5 dark:border-white/10 px-3.5 py-3">
